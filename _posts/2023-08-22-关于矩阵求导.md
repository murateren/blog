...
| $\mathbf{u} = \mathbf{u}(x), \mathbf{v} = \mathbf{v}(x)$ | $\Large \frac{\partial(\mathbf{u}^T \times \mathbf{v})}{\partial{x}}$ | $\large (\frac{\partial{\mathbf{u}}}{\partial{x}})^T  \normalsize \times \mathbf{v} + \mathbf{u}^T \times \large \frac{\partial{\mathbf{v}}}{\partial{x}}$ | $\large \frac{\partial{\mathbf{u}}}{\partial{x}} \times \normalsize \mathbf{v} + \mathbf{u}^T \times \large (\frac{\partial{\mathbf{v}}}{\partial{x}})^T$ | [Proof 3-2](#3-2) | <!-- 3-2 -->
...
| $\mathbf{U} = \mathbf{U}(x), \mathbf{v} = \mathbf{v}(x)$ | $\Large \frac{\partial(\mathbf{U} \times \mathbf{v})}{\partial{x}}$ | $\large \frac{\partial{\mathbf{U}}}{\partial{x}} \times \normalsize \mathbf{v} + \mathbf{U} \times \large \frac{\partial{\mathbf{v}}}{\partial{x}}$ | $\large \normalsize \mathbf{v}^T \times \large \frac{\partial{\mathbf{U}}}{\partial{x}} + \frac{\partial{\mathbf{v}}}{\partial{x}} \times \normalsize \mathbf{U}^T$ | [Proof 3-5](#3-5) | <!-- 3-5 -->
