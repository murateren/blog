...
| $\large $ | $\Large \frac{\partial{\parallel \mathbf{x} \parallel^2}}{\partial{\mathbf{x}}}$ | $2 \mathbf{x}^T$ | $2 \mathbf{x}$ | [Proof 2-8](#2-8) | <!-- 2-8 -->
| $\mathbf{a}, \mathbf{b}$ are not functions of $\mathbf{x}$ | $\Large \frac{\partial({\mathbf{a}^T \mathbf{xx}^T \mathbf{b}})}{\partial{\mathbf{x}}}$ | $\mathbf{x}^T (\mathbf{ab}^T + \mathbf{ba}^T)$ | $(\mathbf{ab}^T + \mathbf{ba}^T) \mathbf{x}$ | [Proof 2-9](#2-9) | <!-- 2-9 -->
| $\mathbf{a}$ is not a function of $\mathbf{x}$ | $\Large \frac{\partial{\parallel \mathbf{x - a} \parallel}}{\partial{\mathbf{x}}}$ | $\large \frac{(\mathbf{x - a})^T}{\parallel \mathbf{x - a} \parallel}$ | $\large \frac{\mathbf{x - a}}{\parallel \mathbf{x - a} \parallel}$ | [Proof 2-10](#2-10) | <!-- 2-10 -->
...
| Codition | Expression | Numerator layout | Denominator layout | Proof |
| :---: | :---: | :---: | :---: | :---: |
| $\large $ | $\large $ | $\large $ | $\large $ | [Proof 3-1](#3-1) | <!-- 3-1 -->
...
- **Proof 1-7**
  - $\color{royalblue}{\LARGE \frac{\partial{\mathbf{g}(\mathbf{u})}}{\partial{\mathbf{x}}}}$, $\; \mathbf{u} = \mathbf{u}(\mathbf{x})$
    ...
    \begin{aligned}
        ...
        \large
        \begin{pmatrix}
            \frac{\partial{g_1}}{\partial{\mathbf{u}}} \frac{\partial{\mathbf{u}}}{\partial{x_1}} & \cdots & \frac{\partial{g_p}}{\partial{\mathbf{u}}} \frac{\partial{\mathbf{u}}}{\partial{x_1}} \\
            \vdots & \ddots & \vdots \\
            \frac{\partial{g_1}}{\partial{\mathbf{u}}} \frac{\partial{\mathbf{u}}}{\partial{x_n}} & \cdots & \frac{\partial{g_p}}{\partial{\mathbf{u}}} \frac{\partial{\mathbf{u}}}{\partial{x_n}}
        \end{pmatrix}_{n \times p}
        \\[10mm]
        &=
        \large
        ...
        \large
        \begin{pmatrix}
            \sum_{i=1}^m \frac{\partial{g_1}}{\partial{u_i}} \frac{\partial{u_i}}{\partial{x_1}} & \cdots & \sum_{i=1}^m \frac{\partial{g_p}}{\partial{u_i}} \frac{\partial{u_i}}{\partial{x_1}} \\
            \vdots & \ddots & \vdots \\
            \sum_{i=1}^m \frac{\partial{g_1}}{\partial{u_i}} \frac{\partial{u_i}}{\partial{x_n}} & \cdots & \sum_{i=1}^m \frac{\partial{g_p}}{\partial{u_i}} \frac{\partial{u_i}}{\partial{x_n}}
        \end{pmatrix}_{n \times p}
        \\[10mm]
        &=
        \large
...
- **Proof 2-1**
  - $\color{royalblue}{\LARGE \frac{\partial{(\mathbf{u \cdot v})}}{\partial{\mathbf{x}}}}$, $\; \mathbf{u} = \mathbf{u}(\mathbf{x}), \; \mathbf{v} = \mathbf{v}(\mathbf{x})$
    ...
    \begin{aligned}
        ...
        &=
        \left(
            \mathbf{v}^T \underset{\bf{Numerator}}{\frac{\partial{\mathbf{u}}}{\partial{\mathbf{x}}}} + \mathbf{u}^T \underset{\bf{Numerator}}{\frac{\partial{\mathbf{v}}}{\partial{\mathbf{x}}}}
        \right)^T
        \\[7mm]
        &=
        \left(\underset{\bf{Numerator}}{\frac{\partial{\mathbf{u}}}{\partial{\mathbf{x}}}}\right)^T {(\mathbf{v}^T)}^T + \left(\underset{\bf{Numerator}}{\frac{\partial{\mathbf{v}}}{\partial{\mathbf{x}}}}\right)^T {(\mathbf{u}^T)}^T
        \\[7mm]
        &=
        \underset{\bf{Denominator}}{\frac{\partial{\mathbf{u}}}{\partial{\mathbf{x}}}} \mathbf{v} + \underset{\bf{Denominator}}{\frac{\partial{\mathbf{v}}}{\partial{\mathbf{x}}}} \mathbf{u}
        \\[7mm]
        &=
...
- **Proof 2-8**
  - $\color{royalblue}{\LARGE \frac{\partial{\parallel \mathbf{x} \parallel^2}}{\partial{\mathbf{x}}}}$
    ...
    $$
    \begin{aligned}
        \frac{\partial{\parallel \mathbf{x} \parallel^2}}{\partial{\mathbf{x}}}
        &=
