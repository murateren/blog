...
\begin{align}
    ...
    % 5
    &= \frac{\partial}{\partial{u}} \left[\frac{1}{2} (\hat{y} - y) ^ 2\right] \frac{\partial{u}}{\partial{\omega_i}} \qquad \cdots \tag{5} (3)\\[3mm]
    % 6
...
\begin{align}
    ...
    &= 
    {\boldsymbol{W^{(L)}}}^T \boldsymbol{\delta^{(L)}} \odot f'^{(L-1)}(\boldsymbol{u^{(L-1)}}) \tag{60}
\end{align}
$$
...
%61
\begin{equation}
    \boldsymbol{(i) \; k=1}, \qquad \boldsymbol{\delta^{(L-k)}} = \boldsymbol{\delta^{(L-1)}} = {\boldsymbol{W^{[(L+1)-1]}}}^T \boldsymbol{\delta^{[(L+1)-1]}} \odot f'^{(L-1)}(\boldsymbol{u^{(L-1)}}) \tag{61}
\end{equation}
$$
...
\begin{align}
    ...
    &= 
    \boldsymbol{\delta^{[(L+1)-{\color{red}{m}}]}} \tag{62} \\[3mm]
    %63
    &= {\boldsymbol{W^{[(L+1)-{\color{red}{m}}]}}}^T \boldsymbol{\delta^{[(L+1)-{\color{red}{m}}]}} \odot f'^{(L-{\color{red}{m}})}(\boldsymbol{u^{(L-{\color{red}{m}})}}) \tag{63}
\end{align}
$$
<div id="6869"></div>
...
\begin{align}
    ...
    &=
    \boldsymbol{\delta^{[L-({\color{red}{m+1}})]}} \tag{64} \\[3mm]
    %65
    &=
    \frac{\partial{E}}{\partial{\boldsymbol{u^{[L-(m+1)]}}}} \tag{65} \\[3mm]
    %66
    &=
    \frac{\partial{E}}{\partial{\boldsymbol{u^{(L-m)}}}} \frac{\partial{\boldsymbol{u^{(L-m)}}}}{\partial{\boldsymbol{u^{[L-(m+1)]}}}} \tag{66} \\[3mm]
    %67
    &=
    \frac{\partial}{\partial{\boldsymbol{u^{[L-(m+1)]}}}} \left(\boldsymbol{W^{(L-m)} y^{[L-(m+1)]}}\right) \boldsymbol{\delta^{(L-m)}} \tag{67} \\[3mm]
    %68
    &=
    \frac{\partial}{\partial{\boldsymbol{u^{[L-(m+1)]}}}} \left(\boldsymbol{W^{(L-m)}} f^{[L-(m+1)]}(\boldsymbol{u^{[L-(m+1)]}})\right) \boldsymbol{\delta^{(L-m)}} \tag{68} \\[3mm]
    %69
    &=
    {\boldsymbol{W^{(L-m)}}}^T \boldsymbol{\delta^{(L-m)}} \odot f'^{[L-(m+1)]}(\boldsymbol{u^{[L-(m+1)]}}) \tag{69} \\[3mm]
    %70
    &=
    {\boldsymbol{W^{[(L+1)-({\color{red}{m+1}})]}}}^T \boldsymbol{\delta^{[(L+1)-({\color{red}{m+1}})]}} \odot f'^{[L-({\color{red}{m+1}})]}(\boldsymbol{u^{[L-({\color{red}{m+1}})]}}) \tag{70}
\end{align}
$$
...
\begin{align}
    % 71
    \boldsymbol{u^{(l)}} &= \boldsymbol{W^{(l)} y^{(l-1)}} \tag{71} \\[3mm]
    % 72
    \boldsymbol{y^{(l)}} &= f^{(l)}(\boldsymbol{u^{(l)}}) \tag{72}
\end{align}
$$
...
%73
\begin{equation}
    \boldsymbol{\delta^{(l)}} ={\boldsymbol{W_{old}^{(l+1)}}}^T \boldsymbol{\delta^{(l+1)}} \odot f'^{(l)}(\boldsymbol{u^{(l)}}) \tag{73}
\end{equation}
$$
...
%74
\begin{equation}
    \boldsymbol{\delta^{(l)}} = (\boldsymbol{y^{(l)}} - \boldsymbol{y})f'^{(l)}(\boldsymbol{u^{(l)}}) \tag{74}
\end{equation}
$$
...
%75
\begin{equation}
    \boldsymbol{W_{new}^{(l)}} = \boldsymbol{W_{old}^{(l)}} - \eta \boldsymbol{\delta^{(l)}} {\boldsymbol{y^{(l-1)}}}^T \tag{75}
\end{equation}
$$
